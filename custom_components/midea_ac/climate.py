...
CONF_KEEP_LAST_KNOWN_STATE = 'keep_last_known_state'
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend({
    ...
    vol.Optional(CONF_KEEP_LAST_KNOWN_STATE, default=False): vol.Coerce(bool)
})
...
async def async_setup_platform(hass, config, async_add_entities,
    ...
    keep_last_known_state = config.get(CONF_KEEP_LAST_KNOWN_STATE)    

    client = midea_device(device_ip, int(device_id), device_port, keep_last_known_state)
    device = client.setup()
    entities = []
